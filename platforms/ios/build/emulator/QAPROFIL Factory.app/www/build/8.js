...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tabs__ = __webpack_require__(534);
...
var TabsPage = /** @class */ (function () {
    function TabsPage(navCtrl, translateService) {
        ...
        this.tab3Root = 'ExitPage';
        this.tab4Root = 'WelcomePage';
        this.tab1Title = " ";
        this.tab2Title = " ";
        this.tab3Title = " ";
        this.tab4Title = " ";
        translateService.get(['TAB1_TITLE', 'TAB2_TITLE', 'TAB3_TITLE', 'TAB4_TITLE']).subscribe(function (values) {
            ...
            _this.tab3Title = "Exit";
            _this.tab4Title = "Home";
        });
    }
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-tabs',template:/*ion-inline-start:"/Users/qaprofil1/Desktop/sql/qaprofilnew/src/pages/tabs/tabs.html"*/'<ion-tabs>\n  \n  <ion-tab [root]="tab1Root" [tabTitle]="tab1Title" tabIcon="ios-pricetags" ></ion-tab>\n  <ion-tab [root]="tab2Root" [tabTitle]="tab2Title" tabIcon="search"></ion-tab>\n \n      <ion-tab color="primary" [root]="tab4Root" [tabTitle]="tab4Title" tabIcon="home"></ion-tab>\n     <ion-tab [root]="tab3Root" [tabTitle]="tab3Title" tabIcon="exit"></ion-tab>\n</ion-tabs>'/*ion-inline-end:"/Users/qaprofil1/Desktop/sql/qaprofilnew/src/pages/tabs/tabs.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_1__ngx_translate_core__["c" /* TranslateService */]])
    ], TabsPage);
    return TabsPage;
}());
