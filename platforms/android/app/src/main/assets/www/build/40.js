...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__exit__ = __webpack_require__(784);
...
var ExitPage = /** @class */ (function () {
    ...
    ExitPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-exit',template:/*ion-inline-start:"/Users/solidwall/Desktop/qaprofilnew/src/pages/exit/exit.html"*/'\n \n\n\n\n   <style>\n.masters {\n \n   background: url(\'assets/img/steel.jpg\') repeat ;\n}\n \n</style>\n\n \n\n<ion-content>\n\n  <ion-list  >\n    <ion-item-sliding >\n       \n           <button class="masters" menuClose ion-item  (click)="presentConfirm()">\n        <table><tr><td><img width="70" height="70" src="assets/img/exit.png" alt=""/></td>\n            <td><h2><b><font   face="Cambria" color="0000" size="7">&nbsp;&nbsp; Exit </font></b></h2></td></tr></table>\n\n         \n         \n        \n       \n      </button>\n \n    </ion-item-sliding>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/solidwall/Desktop/qaprofilnew/src/pages/exit/exit.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* Platform */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], ExitPage);
    return ExitPage;
}());
