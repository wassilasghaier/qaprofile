...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__waveroof__ = __webpack_require__(824);
...
var WaveroofPage = /** @class */ (function () {
    function WaveroofPage(navCtrl, navParams, imageViewerCtrl, platform, userservice, orderservice, http, toastController) {
        var _this = this;
        ...
        this.product2 = false;
        this.isValid = false;
        this.title = "Wave Roof Tile Sheet";
        this.p1 = "";
        this.p2 = "";
        this.orders = [];
    ...
    WaveroofPage.prototype.goToSecond = function (page) {
        this.navCtrl.push(page);
    };
    WaveroofPage.prototype.addToCart = function () {
        if (this.color == null || this.width == null || this.thicknes == null || this.quantity == null || this.quantity < 0) {
            ...
            var data = {
                ...
                image: "assets/img/qaprofil/roof_pannel/wave.png",
    ...
    WaveroofPage.prototype.sendNotification = function (message) {
