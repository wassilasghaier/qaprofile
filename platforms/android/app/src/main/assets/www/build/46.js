...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__anglebead__ = __webpack_require__(778);
...
var AnglebeadPage = /** @class */ (function () {
    function AnglebeadPage(navCtrl, navParams, imageViewerCtrl, platform, userservice, orderservice, http, toastController) {
        var _this = this;
    ...
    AnglebeadPage.prototype.goToSecond = function (page) {
        this.navCtrl.push(page);
    };
    AnglebeadPage.prototype.addToCart = function () {
        if (this.color == null || this.width == null || this.thicknes == null || this.quantity == null || this.quantity < 1) {
            ...
            var data = {
                ...
                image: "assets/img/qaprofil/angle.png",
    ...
    AnglebeadPage.prototype.sendNotification = function (message) {
