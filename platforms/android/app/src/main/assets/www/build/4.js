...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__uchannel__ = __webpack_require__(820);
...
var UchannelPage = /** @class */ (function () {
    function UchannelPage(navCtrl, navParams, imageViewerCtrl, platform, userservice, orderservice, http, toastController) {
        var _this = this;
        ...
        this.product1 = false;
        this.product2 = false;
        this.title = "Prepainted U Channel";
        this.p1 = "";
        this.p2 = "";
        this.orders = [];
    ...
    UchannelPage.prototype.goToSecond = function (page) {
        this.navCtrl.push(page);
    };
    UchannelPage.prototype.addToCart = function () {
        if (this.color == null || this.width == null || this.thicknes == null || this.quantity == null || this.quantity < 0) {
            ...
            var data = {
                ...
                image: "assets/img/qaprofil/u_channel.png",
    ...
    UchannelPage.prototype.sendNotification = function (message) {
