...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__watergater__ = __webpack_require__(823);
...
var WatergaterPage = /** @class */ (function () {
    function WatergaterPage(navCtrl, navParams, imageViewerCtrl, platform, userservice, orderservice, http, toastController) {
        var _this = this;
    ...
    WatergaterPage.prototype.goToSecond = function (page) {
        this.navCtrl.push(page);
    };
    WatergaterPage.prototype.addToCart = function () {
        if (this.color == null || this.width == null || this.thicknes == null || this.quantity == null || this.quantity < 0) {
            ...
            var data = {
                ...
                image: "assets/img/qaprofil/roof_pannel/water_gutter.bmp",
    ...
    WatergaterPage.prototype.sendNotification = function (message) {
