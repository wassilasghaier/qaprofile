...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__perimeter__ = __webpack_require__(801);
...
var PerimeterPage = /** @class */ (function () {
    function PerimeterPage(navCtrl, navParams, imageViewerCtrl, platform, userservice, orderservice, http, toastController) {
        var _this = this;
    ...
    PerimeterPage.prototype.goToSecond = function (page) {
        this.navCtrl.push(page);
    };
    PerimeterPage.prototype.addToCart = function () {
    ...
    PerimeterPage.prototype.sendNotification = function (message) {
