...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__qapcarrier__ = __webpack_require__(806);
...
var QapcarrierPage = /** @class */ (function () {
    function QapcarrierPage(navCtrl, navParams, imageViewerCtrl, platform, userservice, orderservice, http, toastController) {
        var _this = this;
    ...
    QapcarrierPage.prototype.goToSecond = function (page) {
        this.navCtrl.push(page);
    };
    QapcarrierPage.prototype.addToCart = function () {
    ...
    QapcarrierPage.prototype.sendNotification = function (message) {
