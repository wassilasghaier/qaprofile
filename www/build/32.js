...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jtrim__ = __webpack_require__(792);
...
var JtrimPage = /** @class */ (function () {
    function JtrimPage(navCtrl, navParams, imageViewerCtrl, platform, userservice, orderservice, http, toastController) {
        var _this = this;
    ...
    JtrimPage.prototype.goToSecond = function (page) {
        this.navCtrl.push(page);
    };
    JtrimPage.prototype.addToCart = function () {
        if (this.color == null || this.width == null || this.thicknes == null || this.quantity == null || this.quantity < 1) {
            ...
            var data = {
                ...
                image: "assets/img/qaprofil/jtrim.png",
    ...
    JtrimPage.prototype.sendNotification = function (message) {
