...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__semiround__ = __webpack_require__(814);
...
var SemiroundPage = /** @class */ (function () {
    function SemiroundPage(navCtrl, navParams, imageViewerCtrl, platform, userservice, orderservice, http, toastController) {
        var _this = this;
    ...
    SemiroundPage.prototype.goToSecond = function (page) {
        this.navCtrl.push(page);
    };
    SemiroundPage.prototype.producOne = function (e) {
        console.log(this.product1);
        if (this.product1 == true)
            this.p1 = "Semi Round Panel";
        else
            this.p1 = "";
        console.log(this.p1);
    };
    SemiroundPage.prototype.producTwo = function (e) {
        console.log(this.p1 + this.product2);
        if (this.product2 == true)
            this.p2 = "184R Panel - Strip";
        else
            this.p2 = "";
        console.log(this.p2);
    };
    SemiroundPage.prototype.producThree = function (e) {
        console.log(this.p3 + this.product3);
        if (this.product3 == true)
            this.p3 = "134R Panel - Strip";
        else
            this.p3 = "";
        console.log(this.p3);
    };
    SemiroundPage.prototype.addToCart = function () {
            ...
            if (this.color == null || this.width == null || this.thicknes == null || this.quantity == null || this.quantity < 0) {
                ...
                if (this.product1 == true) {
                    var data = {
                        ...
                        image: "assets/img/qaprofil/bambo/2.jpg",
    ...
    SemiroundPage.prototype.sendNotification = function (message) {
    ...
    SemiroundPage.prototype.startApp = function (page) {
