...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__runner__ = __webpack_require__(813);
...
var RunnerPage = /** @class */ (function () {
    function RunnerPage(navCtrl, navParams, imageViewerCtrl, platform, userservice, orderservice, http, toastController) {
        var _this = this;
    ...
    RunnerPage.prototype.goToSecond = function (page) {
        this.navCtrl.push(page);
    };
    RunnerPage.prototype.addToCart = function () {
    ...
    RunnerPage.prototype.sendNotification = function (message) {
